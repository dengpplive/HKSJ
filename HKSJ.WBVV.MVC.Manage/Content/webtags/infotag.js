...
function Infotag(data){
			...
			'<div class="tag-container">' +
			   ...
			   '<div class="info-tags">' +
				   '<div class="tag-cont"></div>' +
					'<div>' +
						'<input class="tag-input" type="text" placeholder="' + Translate("admin_Content_webtags_infotagjs_tagLengthTips").Format(data.maxChar) + '">' +
					'</div>' +
				'</div>' +
			'</div>' +
			'<div class="message tag-message"><span class="message_span" id="message_span">' + Translate("admin_Content_webtags_infotagjs_span_PleaseSelect") + '</span><span>' + Translate("admin_Content_webtags_infotagjs_span_Selectten").Format(10) + '</span></div>' +
			//'<i class="smark">*</i>' +
		'</div>' +
		'<div style="display: block;" class="info-recom-tag">' +
		'<h3>' + Translate("admin_Content_webtags_infotagjs_h3_recTags") + '</h3>' +
			'<div class="tag-list">' +
			'</div>' +
		'</div>';
	...
	if(data.isHasTitle){
		...
		oI.className="smark";
		oH3.innerHTML = Translate("admin_Content_webtags_infotagjs_innerhtmltag");
		oI.innerHTML="*";
	...
	this.oInfoTags.onclick = function (ev) {
		...
		if (oSrc.tagName == "I") {
			...
			This.oMessageSpanRight.innerHTML = Translate("admin_Content_webtags_infotagjs_innerhtmlInputtagCount1").Format((This.oMessNum += 1));
...
Infotag.prototype.addTag=function (str,obj) {
		...
		this.oMessageSpanRight.innerHTML = Translate("admin_Content_webtags_infotagjs_innerhtmlSecondInputtagCount1").Format((this.oMessNum -= 1));
		if(This.oMessNum == 0){
