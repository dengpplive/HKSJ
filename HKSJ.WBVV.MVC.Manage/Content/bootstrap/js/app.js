...
var App = function () {
        ...
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
            if ($(this).next().hasClass('sub-menu') == false) {
                if ($('.btn-navbar').hasClass('collapsed') == false) {
                    ...
                    $(this).parent().siblings().children('.sub-menu').removeAttr("style");
                    handleIframe($(this).attr("url"));
                }
                return;
            }
            ...
            if (sub.is(":visible")) {
                ...
                parent.parent().addClass("start active").siblings().removeClass("start active");
                handleIframe($(this).attr("url"));
            }
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el);
            el.block({
                message: '<img src="Content/bootstrap/image/select2-spinner.gif" align="">',
