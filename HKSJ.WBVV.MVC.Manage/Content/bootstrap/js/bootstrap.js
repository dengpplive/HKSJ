...
function (e) {
    ...
    t.prototype = {
        ...
        backdrop: function (t) {
            ...
            //add by liuzi1989 2014-05-05 
            //当弹出层高度比浏览器高度低，弹出层居中显示
            this.$element.height('auto');
            if ($(window).height() > this.$element.height()) {
                this.$element.css({
                    "top": this.$element.css({ "top": ($(window).height() - this.$element.height()) / 2 })
                })
            }
            else {
                this.$element.css({ "top": 0, height: $(window).height(),overflow:"auto" });
            }
        }
    };
    var n = e.fn.modal;
