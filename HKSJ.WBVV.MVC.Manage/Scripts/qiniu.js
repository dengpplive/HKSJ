                ...
                if (file) {
                    switch (err.code) {
                        case plupload.FAILED:
                            errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_FAILED");
                            break;
                        case plupload.FILE_SIZE_ERROR:
                            var max_file_size = up.getOption && up.getOption('max_file_size');
                            max_file_size = max_file_size || (up.settings && up.settings.max_file_size);
                            errTip = sringFormat(Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_FILE_SIZE_ERROR"), max_file_size);
                            break;
                        case plupload.FILE_EXTENSION_ERROR:
                            errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_FILE_EXTENSION_ERROR");
                            break;
                        case plupload.HTTP_ERROR:
                            if (err.response === '') {
                                // Fix parseJSON error ,when http error is like net::ERR_ADDRESS_UNREACHABLE
                                errTip = err.message || Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_HTTP_ERROR");
                                break;
                            }
                            ...
                            switch (err.status) {
                                case 400:
                                    errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_status_400");
                                    break;
                                case 401:
                                    errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_status_401");
                                    break;
                                case 405:
                                    errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_status_405");
                                    break;
                                case 579:
                                    errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_status_579");
                                    break;
                                case 599:
                                    errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_status_599");
                                    break;
                                case 614:
                                    errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_status_614");
                                    try {
                                    ...
                                    break;
                                case 631:
                                    errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_status_631");
                                    break;
                                case 701:
                                    errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_status_701");
                                    break;
                                default:
                                    errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_status_default");
                                    break;
                            }
                            errTip = errTip + '(' + err.status + '：' + errorText + ')';
                            break;
                        case plupload.SECURITY_ERROR:
                            errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_SECURITY_ERROR");
                            break;
                        case plupload.GENERIC_ERROR:
                            errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_GENERIC_ERROR");
                            break;
                        case plupload.IO_ERROR:
                            errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_IO_ERROR");
                            break;
                        case plupload.INIT_ERROR:
                            errTip = Translate("admin_Scripts_qiniu_QiniuJsSDK_uploader_bind_Error_INIT_ERROR");
                            uploader.destroy();
                            break;
                        default:
