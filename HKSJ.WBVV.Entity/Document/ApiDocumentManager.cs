...
namespace HKSJ.WBVV.Entity.Document
{
    ...
    public class ApiDocumentManager
    {
        ...
        {
            RegisterSampleObject(new ResponsePackage<decimal> { Data = 120, ExtensionData = new ResponseExtensionData { CallResult = CallResult.Success } });
            RegisterSampleObject(new ResponsePackage<double> { Data = 120.0, ExtensionData = new ResponseExtensionData { CallResult = CallResult.Success } });
            RegisterSampleObject(new ResponsePackage<object> { Data = null, ExtensionData = new ResponseExtensionData { CallResult = CallResult.Success } });
        }
