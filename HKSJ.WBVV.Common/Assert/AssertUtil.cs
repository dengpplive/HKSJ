...
namespace HKSJ.WBVV.Common.Assert
{
    /// <summary>
    /// 断言类
    /// </summary>
    ...
    public static class AssertUtil
    {
        ...
        public static void Fault(string msg, Exception innerException)
        {
        ...
        {
            throw new AssertException(LanguageUtil.Translate("com_AssertUtil_DebugFault"));
        }
        #endregion
        /// <summary>
        /// 断言是否正确的Id
        ...
        {
            IsNotNull(o, LanguageUtil.Translate("com_AssertUtil_IsNotNull"));
            if (!(o is T))
                Fault(message);
        }
        ...
        {
            IsNotNull(o1, LanguageUtil.Translate("com_AssertUtil_IsNotNull"));
            IsNotNull(o2, LanguageUtil.Translate("com_AssertUtil_IsNotNull"));
